...
fun SelectItem(
    ...
    ExposedDropdownMenuBox(
        ...
        OutlinedTextField(
            ...
            colors = etsumeOutlinedFieldColors(),
        )
...
@Composable
private fun etsumeOutlinedFieldColors() = OutlinedTextFieldDefaults.colors(
    ...
    disabledContainerColor = MaterialTheme.colorScheme.surface.copy(alpha = 0.78f),
