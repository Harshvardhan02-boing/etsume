...
object Constants {
    const val URL_HELP = "https://github.com/harshtries-code/etsume/wiki/Troubleshooting"
    const val URL_HELP_UPCOMING = "https://github.com/harshtries-code/etsume/wiki/Updates-and-Upcoming"
