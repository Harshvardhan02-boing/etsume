        ...
        Column(
            ...
            FlowRow(
                ...
                QuickActionChip(
                    ...
                    label = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_player_subtitles),
                    onClick = onOpenSubtitles,
                )
                QuickActionChip(
                    icon = Icons.Default.Audiotrack,
                    label = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_player_audio),
                    onClick = onOpenAudioTracks,
                )
                QuickActionChip(
                    icon = Icons.Default.HighQuality,
                    label = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_player_quality),
                    onClick = onOpenQualityTracks,
                )
                QuickActionChip(
                    icon = Icons.AutoMirrored.Filled.ViewList,
                    label = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_player_episode_list),
                    onClick = onOpenEpisodeList,
                )
                onEnterPip?.let {
                    QuickActionChip(
                        icon = Icons.Default.PictureInPictureAlt,
                        label = stringResource(AYMR.strings.pref_category_pip),
                        onClick = it,
                    )
                }
            }
            ...
            Row(
                ...
                Row(
                    ...
                    TextButton(onClick = onOpenComments) {
                        Text(text = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_comments_title))
                    }
                }
            }
