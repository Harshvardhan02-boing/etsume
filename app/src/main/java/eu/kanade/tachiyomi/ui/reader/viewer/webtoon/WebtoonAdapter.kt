...
class WebtoonAdapter(val viewer: WebtoonViewer) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun setChapters(chapters: ViewerChapters, forceTransition: Boolean) {
        ...
        // Keep chapter changes explicit. We always show the transition card instead of letting
        // the reader bleed directly into adjacent chapter pages.
        // Add current chapter.
        ...
        if (nextHasMissingChapters || forceTransition || chapters.nextChapter != null || chapters.nextChapter?.state !is ReaderChapter.State.Loaded) {
