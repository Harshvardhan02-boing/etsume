...
import eu.kanade.presentation.reader.components.ReaderChapterDrawer
    ...
    private fun initializeMenu() {
        ...
        binding.dialogRoot.setComposeContent {
            ...
            ReaderAppBars(
                ...
                onOpenChapterList = viewModel::openChapterListDialog,
                currentPage = state.currentPage,
                totalPages = state.totalPages,
                onPageIndexChange = {
            ...
            ReaderChapterDrawer(
                visible = state.dialog is ReaderViewModel.Dialog.ChapterList,
                chapters = state.chapterDrawerItems,
                onDismissRequest = onDismissRequest,
                onOpenChapter = {
                    onDismissRequest()
                    viewModel.openChapterById(it)
                },
            )
            ...
            when (state.dialog) {
                ...
                is ReaderViewModel.Dialog.Settings -> {
                    ReaderSettingsDialog(
                        ...
                        initialPage = (state.dialog as ReaderViewModel.Dialog.Settings).initialPage,
                        commentDraftKey = "reader_manga_${state.currentChapter?.chapter?.id ?: 0L}",
                    )
                }
                ReaderViewModel.Dialog.ChapterList -> {}
