...
object SettingsTrackingScreen : SearchableSettings {
    ...
    override fun RowScope.AppBarAction() {
        ...
        IconButton(onClick = { uriHandler.openUri("https://github.com/harshtries-code/etsume/wiki/Tracking") }) {
            Icon(
    ...
    override fun getPreferences(): List<Preference> {
        ...
        val connectedCount = trackerManager.loggedInTrackers().size
        val totalCount = trackerManager.trackers.size
...
@Composable
private fun TrackingOverviewCard(
    connectedCount: Int,
    totalCount: Int,
) {
    EtsumeTrackCard(
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_tracking_heading),
                        style = MaterialTheme.typography.titleMedium,
                    )
                    Text(
                        text = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_tracking_summary),
            ...
            Surface(
                ...
                Text(
                    text = androidStringResource(eu.kanade.tachiyomi.R.string.etsume_tracking_hint),
